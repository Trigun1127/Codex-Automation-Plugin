...
description: "Create, inspect, update, delete, explain, or troubleshoot Codex automations from a plain-English request."
---
...
3. Prefer the native Codex automation surface when available in the session.
   ...
   - If the user invoked this through a skill mention, still prefer the native tool; the skill is instruction packaging, not the scheduler itself.
